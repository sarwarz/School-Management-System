$(function () {
	...
	$("#select_all").click(function(){
		// Check or uncheck all checkboxes in the table body based on the "select all" checkbox state
		$('input[name="selected_records[]"]').prop('checked', $(this).prop('checked'));
	});

	// When any checkbox in the table body is clicked
	$('input[name="selected_records[]"]').click(function(){
