    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            <div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"> Add Mark Grade</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page"> Add Mark Grade</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-3">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0"> Add Mark Grade</h5>
                            </div>
                            <hr>
                            <form class="row g-3" action="{{ route('admin.mark.grade.create') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" step="any" class="form-control @error('point') is-invalid @enderror" id="point" name="point" placeholder="Enter point" value="{{ old('point', $grade->point ?? '') }}">
                                    @error('point')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control @error('percent_from') is-invalid @enderror" id="percent_from" name="percent_from" placeholder="Enter Percent From">
                                    @error('percent_from')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control @error('percent_upto') is-invalid @enderror" id="percent_upto" name="percent_upto" placeholder="Enter Percent Upto">
                                    @error('percent_upto')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('remarks') is-invalid @enderror" id="remarks" name="remarks" placeholder="Enter remarks">
                                    @error('remarks')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
