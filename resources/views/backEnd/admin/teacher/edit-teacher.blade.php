    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            <div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Edit Teacher</div>
                <div class="ps-3">
                        ...
                        <div class="card-body p-3">
                            ...
                            <form class="row g-3" action="{{ route('admin.teacher.update',$teacher->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="teacher_id" class="form-control @error('teacher_id') is-invalid @enderror" placeholder="Enter Teacher ID" value="{{ $teacher->teacher_id ?? '' }}">
                                    @error('teacher_id')<span class="invalid-feedback">{{ $message }}</span>@enderror
                                </div>

                                <div class="col-md-6">
                                    <label class="form-label">First Name<span class="text-danger">*</span></label>
                                    <input type="text" name="first_name" class="form-control @error('first_name') is-invalid @enderror" placeholder="Enter first name" value="{{ $teacher->first_name ?? '' }}">
                                    @error('first_name')<span class="invalid-feedback">{{ $message }}</span>@enderror
                                </div>

                                <div class="col-md-6">
                                    <label class="form-label">Last Name</label>
                                    <input type="text" name="last_name" class="form-control" placeholder="Enter last name" value="{{ $teacher->last_name ?? '' }}">
                                </div>

                                <div class="col-md-6">
                                    <label class="form-label">Email<span class="text-danger">*</span></label>
                                    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="Enter email" value="{{ $teacher->email ?? ''}}">
                                    @error('email')<span class="invalid-feedback">{{ $message }}</span>@enderror
                                </div>

                                <div class="col-md-6">
                                    <label class="form-label">Phone<span class="text-danger">*</span></label>
                                    <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="Enter phone number" value="{{ $teacher->phone ?? '' }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" name="date_of_birth" value="{{ $teacher->date_of_birth  }}" class="form-control @error('date_of_birth') is-invalid @enderror">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="designation_id" class="form-control @error('designation_id') is-invalid @enderror">
                                        ...
                                        @foreach ($designations as $designation)
                                            <option value="{{ $designation->id }}" @selected(  $designation->id == $teacher->designation_id )>
                                                {{ $designation->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="department_id" class="form-control @error('department_id') is-invalid @enderror">
                                        ...
                                        @foreach ($departments as $department)
                                            <option value="{{ $department->id }}" @selected(  $department->id == $teacher->department_id ) >
                                                {{ $department->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" step="0.01" name="basic_salary" class="form-control @error('basic_salary') is-invalid @enderror" placeholder="Enter basic salary" value="{{ $teacher->basic_salary ?? '' }}" >
                                    @error('basic_salary')<span class="invalid-feedback">{{ $message }}</span>@enderror
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Address<span class="text-danger">*</span></label>
                                    <input type="text" name="address" class="form-control @error('address') is-invalid @enderror" placeholder="Enter address" value="{{ $teacher->address ?? '' }}" >
                                ...
                                <div class="col-md-6">
                                    ...
                                    @if(isset($teacher) && $teacher->image)
                                        <div class="mt-2">
                                            <img src="{{ asset($teacher->image) }}" alt="Teacher Photo" width="95" height="95" style="border-radius: 5px; object-fit: cover;">
                                        </div>
                                    @endif
                                </div>
