    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            <div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"> Edit Designation</div>
                <div class="ps-3">
                ...
                <div class="col-md-12">
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-3">
                            ...
                            <hr>
                            <form class="row g-3" action="{{ route('admin.teacher.designation.update',$teacherDesignation->id) }}" method="post">
                                @csrf
                                @method('put')
                                <div class="col-md-6">
                                    <label for="name" class="form-label">Name<span class="fillable">*</span></label>
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="enter designation name" value="{{ $teacherDesignation->name }}">
                                    @error('name')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control @error('status') is-invalid @enderror" name="status" id="status">
                                        <option @selected( $teacherDesignation->status == 1 ) value="1">Active</option>
                                        <option @selected( $teacherDesignation->status == 0 ) value="0">Inactive</option>
                                    </select>
                                    @error('status')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
